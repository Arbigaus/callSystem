...
<div class="register-box">
  <div class="register-logo">
    <a href="<?php echo BASE; ?>/login"><b>Sistema</b>MVC</a>
  </div>
  ...
  <div class="alerta ">
    ...
    <form method="post" id="login/add">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="user_passwd" class="form-control passwd" placeholder="Senha">
    ...
    <a href="<?php echo BASE; ?>/login" class="text-center">Já sou cadastrado</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
