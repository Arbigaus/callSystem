...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo BASE; ?>/assets/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo BASE; ?>" class="logo">
      ...
      <span class="logo-lg"><b>Atendimento</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo BASE; ?>/assets/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo BASE; ?>/assets/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo BASE; ?>/assets/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> Hello
                    </a>
                  </li>
                  <li>
                    <a href="#">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo BASE; ?>/assets/dist/img/<?php echo $LoggedUser['user_profilepic']; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $LoggedUser['user_name']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo BASE; ?>/assets/dist/img/<?php echo $LoggedUser['user_profilepic']; ?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $LoggedUser['user_name']; ?>
                  <small>Membro desde <?php echo date("M. Y",strtotime($LoggedUser['user_date'])); //TODO: Imprimir data formatada. ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo BASE; ?>/profile" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo BASE; ?>/login/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $LoggedUser['user_name']; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo BASE; ?>/cell/csv"><i class="fa fa-mobile"></i> <span>Enviar CSV-Claro</span></a></li>
				...
				<li><a href="<?php echo BASE; ?>/docs"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo BASE; ?>/assets/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo BASE; ?>/assets/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo BASE; ?>/assets/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo BASE; ?>/assets/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo BASE; ?>/assets/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo BASE; ?>/assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo BASE; ?>/assets/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php echo BASE; ?>/assets/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo BASE; ?>/assets/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo BASE; ?>/assets/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo BASE; ?>/assets/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?php echo BASE; ?>/assets/dist/js/pages/dashboard.js"></script>
